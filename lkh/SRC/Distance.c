...
int Distance_GEOM(Node * Na, Node * Nb)
{
    ...
    return M_RRR * atan2(sqrt(q1 * q1 + q2 * q2), q5) + 1.0;
}
...
static double Meuss(double lat1, double lon1,
...
int Distance_GEO_MEEUS(Node * Na, Node * Nb)
{
    ...
    return Meuss(lat1, lon1, lat2, lon2) + 0.5;
}
...
int Distance_GEOM_MEEUS(Node * Na, Node * Nb)
{
    ...
    return 1000 * Meuss(lat1, lon1, lat2, lon2) + 0.5;
}
